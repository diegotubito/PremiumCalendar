...
let FECHA_MI_CALENDARIO = "dd-MM-yyyy"
let FECHA_CON_HORA = "dd-MM-yyyy HH:mm:ss".localized
let FECHA_CON_HORA_SIN_SEGUNDOS = "dd-MM-yyyy HH:mm".localized
let FECHA = "dd-MM-yyyy".localized
let HORA = "HH:mm:ss"
let HORA_SIN_SEGUNDOS = "HH:mm"
let HORA_24HS = "HH:mm a"
let HORA_CONSEGUNDOS_24HS = "HH:mm:ss a"

let arrayNombreDias = ["domingo".localized,
                               "lunes".localized,
                               "martes".localized,
                               "miercoles".localized,
                               "jueves".localized,
